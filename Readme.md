<!-- HEADER_START: {"lang": "de"} -->Dokumentation
# Abwassersurveillance AMELAG - Wochenbericht

<br> 
<br> 
<br> **[Robert Koch-Institut](https://www.rki.de/)**, & **[Umweltbundesamt](https://www.umweltbundesamt.de/)**
<br> <br> **Zitieren**  
...
- <!-- TOC_START: {"heading_depth": 2} -->[Informationen zum Entstehungskontext](#informationen-zum-entstehungskontext)
...
<!-- TOC_END --><br><!-- HEADER_END --><br>---**[--- please find the English version here ---](https://github.com/robert-koch-institut/Abwassersurveillance_AMELAG_-_Wochenbericht/blob/main/Readme.en.md)**
## <br>Informationen zum Entstehungskontext
...
### <!-- FOOTER_START: {"lang": "de"} -->Metadaten
...
<!-- FOOTER_END --><!-- HEADER_START: {"lang": "de"} -->Dokumentation
# Abwassersurveillance AMELAG - Wochenbericht
